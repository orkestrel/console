...
// package). The four constants below are this package's own, and are the only part
...
/**
 * Each import specifier this package's own guides may resolve against — cross-face
 * imports are real in this multi-face package (console.md fences import
 * `createProcessCapture` from `@src/server` alongside core exports), so the fence-
 * import check resolves each specifier to ITS OWN face's exports.
 */
