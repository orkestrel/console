...
const PACKAGE_NAME = '@orkestrel/console'
/**
 ...
 * whose tagline the README pitch equals.
 */
const GUIDE_SPEC = 'guides/console.md'
...
await new GuideCommand({
	...
	const { createRecordingSink, normalizeVisible } = await import('./setup.js')
	const { createStreamTarget, createWriteProbe } = await import('./setupServer.js')
